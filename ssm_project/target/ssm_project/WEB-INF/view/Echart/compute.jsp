         ...
         <div class="panel-heading">
             ...
             <div class="panel-body">
                   ...
                   <select class="combox" id="cost" name="tagId"  multiple>
                      	<optgroup label="运维成本">
							<option value="单位周期设备维修成本">设备维修成本</option>
							<option value="人员运维成本">人员运维成本</option>
							<option value="网络运维成本">网络运维成本</option>
						</optgroup>
						<optgroup label="建设成本">
							<option value="建设总成本">建设总成本</option>
						</optgroup>
                   </select>
                   </br></br>
...
$('#submit').click(function(){
	...
	var reqParams={'benefitName':temp,'costName':cost};
